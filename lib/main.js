...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            (0, core_1.info)(`fetched the name of changed files ${changedFileNames}`);
            const approvers = yield getPRReviews(octokit, prNumber);
            (0, core_1.info)(`fetched the list of PR approvers ${approvers}`);
